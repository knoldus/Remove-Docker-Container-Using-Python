...
ending_string="..........All containers have been removed.........."

print(" We are going to remove all the containers in your local system:--")
...
for container in all_container_list:
            ...
            time.sleep(0.5)
            print("This is the container status:- ", container.status)
            time.sleep(0.5)
            print("This is the container image:- ", container.image)
            time.sleep(0.5)
            print("\n")
